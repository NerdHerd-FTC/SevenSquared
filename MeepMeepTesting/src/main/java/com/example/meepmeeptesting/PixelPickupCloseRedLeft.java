...
public class PixelPickupCloseRedLeft {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(12, -63, Math.toRadians(90)))
                                .splineToLinearHeading(new Pose2d(3, -30, Math.toRadians(135)), Math.toRadians(135))
                                .back(10)
                                .splineToSplineHeading(new Pose2d(54, -24, Math.toRadians(0)), Math.toRadians(0))
                                .strafeLeft(24)
